              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle"
                       src="assets/icon/defaultStudent.svg"
                       style="width:60%;border-radius:50%;">
                </div>

                <h3 class="profile-username text-center text-primary">Estudiante</h3>
                  ...
                  <div class="active tab-pane" id="settings">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="password" class="form-control" id="inputName3" placeholder="nueva contraseña">
                        </div>
                      </div>
