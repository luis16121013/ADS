...
class Student implements IProcedure{
    private $db=null;
    ...
    public function getData($id=0){
        ...
        $sql="SELECT tm.id, tm.codigo, tm.dni, tm.firstName, tm.lastName, tm.nivelAcademico, tm.grado, tm.seccion, tm.email, tu.idUser, tm.sexo FROM table_users tu, table_students tm WHERE tu.idUser=tm.idUser ".$condicion;
        $rs=array();
